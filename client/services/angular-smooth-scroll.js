...
(function () {
	...
	var module = angular.module('smoothScroll', ['angular-meteor']);
	 ...
	 */
 	...
 	// expose the function in a factory
 	module.factory('smoothScroll', function() {
 	    return smoothScroll;
 	});

 	// the directive scrollTo, that use smoothscroll
 	module.directive('scrollTo', function(smoothScroll) {
 	    return {
 	        restrict: 'A',
 	        scope: {
 	            callbackBefore: '&',
